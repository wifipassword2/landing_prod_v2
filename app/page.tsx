  ...
  return (
    <main className=''>
      <div className='absolute overflow-auto inset-0 h-[100lvh] bg-gradient-to-tl via-15% lg:via-10% to 90% from-[#FF6347]  via-[#1C1C1E] to-[#404044]'>
        ...
        <p className='text-[#FFFFFF] text-xs font-pf-logo2 max-w-[100%] '>The Computer Repair and Tech Support </p><p className='text-[#FF6347] custom drop-shadow-2xl shadow-black'> Service №8</p></h1>
        </nav>
      ...
      <div  className="min-h-screen  p-2 font-pf-duza relative z-10 text-[#989899] text-shadow-lg text-[18px] lg:grid lg:grid-cols-3 gap-4  lg:grid-flow-col lg:flex-shrink">
        <div className='bg-[#1E1E1F] bg-opacity-100 rounded-sm p-[20px] pt-[28px] shadow-xl m-4 min-w-[250px] max-w-[340px] mx-auto h-fit lg:row-span lg:order-2'><p className='mb-4'>I specialize in <span className='text-[#FFFFFF]'>solving common computer and laptop problems</span>. With years of hands-on experience, I can offer quick and efficient solutions, whether it's <span className='text-[#FFFFFF]'>software or hardware</span> issues.</p> 
        ...
        {/* pricing card */}
        <div className='bg-[#1E1E1F] bg-opacity-100 rounded-sm p-[20px] pt-[28px] pb-6 shadow-xl mt-[4rem] lg:mt-4 m-4 min-w-[250px] max-w-[340px] mx-auto h-fit lg:order-4'><p className='text-[#FFFFFF] text-2xl m-[2rem] mb-[1rem] mt-1 text-center '>Pricing:</p>
        ...
        <p className='mt-4 ml-3'>Each subsequent hour: <span className='text-[#caced2]'>$60</span></p>
        ...
        <p className='mt-4 ml-3'> plus there is a <span className='text-[#caced2]'>$50</span> flat fee for any on-site repairs (to cover travel time, fuel etc.)</p>
        ...
        {/* contacts card */}
        <div className='mt-[4rem] lg:mt-[-4rem] bg-[#1E1E1F] bg-opacity-100 rounded-sm p-[20px] pt-[28px] pb-6 shadow-xl  m-4 min-w-[250px] max-w-[320px] mx-auto h-fit lg:order-5'><p className='text-[#FFFFFF] text-2xl m-[2rem] mb-[1rem] mt-1 text-center ml-0 '>My contacts:</p>
        <address className=' '>
          <span className='flex '><a href='mailto:help@service8.ca' className=' text-[#237CC9] font-sans underline text-lg hover:no-underline flex'><Image src={email} className='align-middle w-[1.5rem] h-[1.5rem] m-1.5 mr-4' alt="email icon" />help@service8.ca</a><span className='text-xl black'></span> 
          <button></button>
        </span>
        ...
        {/* location card */}
        <div className='bg-[#1E1E1F] bg-opacity-100 rounded-sm p-[20px] pt-[28px] pb-6 shadow-xl mt-[4rem] mb-1 m-4 min-w-[250px] max-w-[380px] mx-auto h-fit lg:order-2 lg:-mt-[1rem]'><p className='text-[#FFFFFF] text-2xl m-[2rem] mt-0 mb-6 text-center'>Location:</p>
